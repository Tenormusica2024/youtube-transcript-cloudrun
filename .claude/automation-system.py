...
class ClaudeAutomationSystem:
    ...
    def call_claude_agent(self, agent_type: str, task: str, actions: List[str], agent_details: Dict):
...
"""
        ...
        try:
            ...
            result = subprocess.run(claude_cmd, cwd=self.base_dir, capture_output=True, text=True)
