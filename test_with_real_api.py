            ...
            with open(env_file, 'r') as f:
                for line in f:
                    if line.startswith('YOUTUBE_API_KEY='):
                        ...
                        if api_key and not api_key.startswith('your-') and not api_key.startswith('AIzaSyBF-'):
...
def test_transcript_extraction():
    ...
    for test_url in test_urls:
        ...
        try:
            ...
            video_id = test_url.split('v=')[-1].split('&')[0] if 'v=' in test_url else test_url.split('/')[-1]
