                ...
                def wrapper(*args, **kwargs):
                    ...
                    if cache_key in self.cache:
                        ...
                        if now - cached_item['timestamp'] < timeout:
                            ...
                            response.headers['X-Cache-Age'] = str(int(now - cached_item['timestamp']))
                            return response
                        else:
                            # Remove expired item
                    ...
                    if hasattr(result, 'headers'):
                        ...
                        result.headers['X-Cache-Stats'] = f"hits:{self.cache_stats['hits']},misses:{self.cache_stats['misses']}"
                    ...
                    try:
                        ...
                        if isinstance(data, dict):
                            ...
                            if optimized_data != data:
                                response.data = json.dumps(optimized_data, separators=(',', ':'))
